...
def create_csv(user, data):
    ...
    try:
        ...
        print("Error:", e)
        print("Data causing the error:", data)  # Print data causing the error
...
def main():
    ...
    default_native_lang = st.session_state.get("user._native_lang", languages[0])
    default_target_lang = st.session_state.get("user._target_lang", languages[4])
